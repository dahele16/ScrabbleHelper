...
#include "Graph.h"
 ...
 class ProcesadorComandos{
  public:  
    ...
    static void grafoDePalabras(std::list<Palabra>* palabras, Graph* grafoPalabras);
    ...
    void agregarPalabrasGrafo(std::list<Palabra>* palabras, Graph* grafoPalabras);
    void agregarConexionesGrafo(Graph* grafoPalabras);
    //bool hayConexion(std::string pal1,std::string pal2); 
    static bool esValida(std::string palabra);
};
